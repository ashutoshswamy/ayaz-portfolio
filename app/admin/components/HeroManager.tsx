  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-medium leading-6 text-[var(--text-light)]">Hero Profile Image</h3>
      ...
      <div className="flex justify-center">
        {heroImage ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-semibold text-[var(--text-light)]">No hero image</h3>
            <p className="mt-1 text-sm text-[var(--text-muted)]">Upload an image to display in the hero section.</p>
          </div>
        )}
      </div>
